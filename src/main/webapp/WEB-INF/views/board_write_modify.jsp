...
<%
	...
	String category = board.getCategories();
    ...
    <main>  	
    	<form action="boardModifyOk.do" method="POST">
	        ...
	        <div class="summernote-container">        
		        ...
		        <label>작성자: </label><input type="text" name="nickname" id="nickname" value="<%=writer %>" readonly />
		        <label>카테고리: </label>
		        ...
		        <br>
		    	<label>제목: </label>&nbsp;<input type="text" name="subject" id="subject" value="<%=subject %>" />   
		    	</div>     
		    	<br>
			    <textarea class="summernote" name="content" id="content"><%=content %></textarea>		    
				<button type="submit" id="submit-button" class="submit-button">수정완료</button>
			</div>		
		</form>
